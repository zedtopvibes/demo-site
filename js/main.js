                ...
                <div class="item-container">
                    <div class="item-thumb">
                        <img src="${getPlaylistImage(compilation)}" 
                             width="80" height="80" 
                             class="roundthumb" 
                             alt="${escapeHtml(compilation.name)}"
                             data-type="playlist"
                             onerror="handleImageError(this)">
                    </div>
                    <div class="item-data">
                        <span class="track-title"><b>${escapeHtml(compilation.name)}</b> <span class="compilation-badge">Compilation</span></span>
                        <div class="artist-name">${escapeHtml(compilation.created_by || 'Various Artists')}</div>
                        <span class="item-meta"><b style="color:#ff0000">${compilation.track_count || 0} items</b></span>
                    </div>
                </div>
            </a>
        `).join('');
